...
You can you Google scholar to easily copy the bibtex and add it to the \verb#references.bib# file
For instance, these works \cite{einstein, knuth-fa} are awesome.
